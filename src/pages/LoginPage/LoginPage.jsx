        ...
        <div className="panels-container">
          <div className="panel left-panel">
            <div className="content">
              ...
              <CustomButton text="sign up" id="sign-up-btn" className="btn" additionalClass="transparent" />
            </div>
          ...
          <div className="panel right-panel">
            <div className="content">
              ...
              {/* sử dụng custom button với id và className "btn" và thêm class "transparent" */}
              <CustomButton text="sign in" id="sign-in-btn" className="btn" additionalClass="transparent" />
            </div>
